  ...
  return (
    ...
    <div className=" mx-auto max-w-7xl px-6 lg:px-8">
      <div className=" sticky mx-auto max-w-2xl lg:text-center">
        <h2 className=" font-semibold text-xl  leading-7 text-blue-600">Get Secure Now!</h2>
      ...
      <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-12 lg:max-w-4xl">
        <dl className="grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
          <div className="relative pl-16">
            <dt className="inline font-bold bg-gradient-to-r from-violet-500 to-blue-600 bg-clip-text text-transparent">
              <div className="absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg">
                <svg className="h-7 w-7 text-blue-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
                </svg>
              </div>
              Uploaded To Cloud
            </dt>
            <dd className="mt-2 text-base leading-7 text-gray-100">A few clicks to get various insights on how to navigate the maze of the market. Doesn't sound too bad, does it?</dd>
          </div>
          ...
          <div className="relative pl-16">
            ...
            <dd className="mt-2 text-base leading-7 text-gray-100">Sit back, put your feet up while our state-of-the-art algorithms improve your portfolio (and profits) as per your needs.</dd>
          </div>
